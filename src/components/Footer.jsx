        ...
        <footer className="w-full py-5 bg-black">
            <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-2 lg:px-0">
                <div className="inline-flex items-center">
                    {user ? (
                        <Link to="/browse">
                            <span className="ml-4 text-xl font-bold text-[#e50914] select-none">
                                MovieGPT
                            </span>
                        </Link>
                    ) : (
                ...
                {user ? null : (
                    <div className="hidden items-center md:inline-flex">
                        ...
                        <Link to="/login">
                            <button
                                type="button"
                                className="ml-2 rounded-md bg-white px-3 py-2 text-sm font-semibold text-black shadow-sm hover:bg-white/80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black">
                                Get Started
                            </button>
                        </Link>
                    </div>
            ...
            <div className="mx-auto flex max-w-6xl flex-col items-start space-x-8 md:flex-row">
                <div className="w-full flex flex-col gap-y-8 md:gap-y-12 px-4 md:w-1/2 lg:px-0">
                    <div className="">
                        <h1 className="max-w-sm text-2xl font-bold text-white/80">
                        ...
                        <form
                            ...
                            <input
                                className="flex h-10 w-full rounded-md text-white border border-white/50 bg-transparent px-3 py-2 text-sm placeholder:text-gray-500  focus:outline-none focus:ring-1 focus:ring-white/30 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50"
                                type="email"
                                placeholder="Email"></input>
                            <button
                                type="button"
                                className="ml-4 rounded-full bg-black bg-white/80 px-3 py-3 text-sm font-semibold text-black shadow-sm hover:bg-white/80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white">
                    ...
                    <div className="-m-1.5 flex flex-wrap">
                        <div className="w-auto p-1.5">
                            <a href="https://github.com/AmitKrVr">
                                <div className="bg-white/80 flex h-8 w-8 items-center justify-center rounded-full border border-gray-300 hover:border-gray-400 dark:border-gray-200 dark:hover:border-gray-300">
                                    <svg
                                        width="16"
                                        viewBox="0 0 16 16"
                                        fill="none"
                        ...
                        <div className="w-auto p-1.5">
                            <a href="https://twitter.com/AmitKrVr">
                                <div className="bg-white/80 flex h-8 w-8 items-center justify-center rounded-full border border-gray-300 hover:border-gray-400">
                                    <svg
                                        width="14"
                                        height="11"
                                        viewBox="0 0 14 11"
                        ...
                        <div className="w-auto p-1.5">
                            <a href="https://www.instagram.com/AmitKrVr">
                                <div className="bg-white/80 flex h-8 w-8 items-center justify-center rounded-full border border-gray-300 hover:border-gray-400">
                                    <svg
                                        width="16"
                                        height="15"
                ...
                <div className="mt-8 grid grid-cols-2 gap-6 md:mt-0 lg:w-3/4 lg:grid-cols-3">
                    <div className="mb-8 lg:mb-0">
                        ...
                        <ul className="flex flex-col space-y-4 text-[14px] font-medium text-gray-500">
                            ...
                            <li className="cursor-pointer">Company History</li>
                    ...
                    <div className="mb-8 lg:mb-0">
                        ...
                        <ul className="flex flex-col space-y-4 text-[14px] font-medium text-gray-500">
                            <li className="cursor-pointer">Claim</li>
            ...
            <div className="mx-auto text-right max-w-6xl px-4 py-2 lg:px-0 mt-4 md:mt-3">
                <p className="text-sm font-medium text-gray-500">
                    © 2024 MovieGPT. All rights reserved.
                </p>
            </div>
        </footer>
    );
